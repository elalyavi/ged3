...
ActiveRecord::Schema.define(version: 20170524164215) do
  ...
  add_index "tours", ["itinerary_id"], name: "index_tours_on_itinerary_id", using: :btree
  ...
  add_foreign_key "tours", "itineraries"
end
