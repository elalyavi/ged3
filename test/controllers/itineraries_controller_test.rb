...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { city_id: @itinerary.city_id, desc: @itinerary.desc, name: @itinerary.name, price: @itinerary.price }
    end
  ...
  test "should update itinerary" do
    patch :update, id: @itinerary, itinerary: { city_id: @itinerary.city_id, desc: @itinerary.desc, name: @itinerary.name, price: @itinerary.price }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
